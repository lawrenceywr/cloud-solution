...
export function createScn08HighReliabilityRackLayoutFixture(): CloudSolutionSliceInput {
  return {
    ...
    ports: [
      ...
      {
        id: "port-tor-b-business-1",
        deviceId: "device-tor-b",
        name: "eth1/1",
        purpose: "server-business-b",
        portType: "business",
        portIndex: 1,
        sourceRefs: [],
        statusConfidence: "confirmed",
    ...
    links: [
      ...
      {
        id: "link-server-a-business-b",
        endpointA: { portId: "port-server-a-business-2" },
        endpointB: { portId: "port-tor-b-business-1" },
        purpose: "server-a-business-secondary",
        linkType: "business",
        redundancyGroup: "server-a-business-dual-home",
        cableId: "CAB-002",
        cableName: "server-a-business-b",
        cableSpec: "DAC-25G",
        cableCount: 1,
        sourceRefs: [],
        statusConfidence: "confirmed",
