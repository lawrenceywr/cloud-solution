...
export function createScn08HighReliabilityRackLayoutFixture(): CloudSolutionSliceInput {
  return {
    requirement: {
      id: "req-scn-08",
      projectName: "SCN-08 High Reliability Rack Layout",
      scopeType: "data-center",
      artifactRequests: [
        "device-rack-layout",
        "device-cabling-table",
      ...
      sourceRefs: [
        {
          kind: "document",
          ref: "evidence/scn-08-rack-layout-template.xlsx",
          note: "Rack layout template",
        },
        {
          kind: "document",
          ref: "evidence/scn-08-cabling-template.xlsx",
          note: "Cable planning template",
        },
        {
          kind: "document",
          ref: "evidence/scn-08-port-plan.xlsx",
          note: "Port plan workbook",
        },
        {
          kind: "diagram",
          ref: "evidence/scn-08-topology.pdf",
          note: "Confirmed topology diagram",
        },
      ],
      statusConfidence: "confirmed",
    },
    ...
    devices: [
      ...
      },
      {
        ...
        rackUnitHeight: 1,
        highAvailabilityGroup: "tor-pair-a",
        highAvailabilityRole: "secondary",
        powerWatts: 350,
        sourceRefs: [],
        statusConfidence: "confirmed",
      },
    ...
    ports: [
      ...
      {
        id: "port-tor-b-storage-21",
        deviceId: "device-tor-b",
        name: "eth1/21",
        purpose: "server-storage-b",
        portType: "storage",
        portIndex: 21,
        sourceRefs: [],
        statusConfidence: "confirmed",
    ...
    links: [
      {
        id: "link-server-a-business-a",
        endpointA: { portId: "port-server-a-business-1" },
        endpointB: { portId: "port-tor-a-business-1" },
      ...
      {
        id: "link-server-a-storage-b",
        endpointA: { portId: "port-server-a-storage-2" },
        endpointB: { portId: "port-tor-b-storage-21" },
        purpose: "server-a-storage-secondary",
        linkType: "storage",
        redundancyGroup: "server-a-business-dual-home",
        cableId: "CAB-002",
        cableName: "server-a-storage-b",
        cableSpec: "DAC-25G",
        cableCount: 1,
        sourceRefs: [],
        statusConfidence: "confirmed",
