...
const documentAssistedExtractionSystemPrompt = [
  ...
  "Inspect only the provided local document, image, or diagram refs plus any approved advisory external sources in the brief.",
  ...
  "When advisorySources are provided, use their advisoryText as non-confirmed external reading input tied to the original sourceRef.",
  ...
  "Every extracted fact must include at least one sourceRef copied from the provided documentSources or advisorySources.",
